  ...
  context "when user is signed in" do
    ...
    describe "UPDATE 'account'" do
      ...
      it "should remove avatar if avatar value is 'remove'" do
        ...
        assigns(:profile).avatar.to_s.should eq "//d2rbi2fqode2pf.cloudfront.net/users/avatars/avatar#{@user.id % 5}.jpg"
        response.code.should eq "200"
      end
    end
    ...
    describe "uploading avatars" do
      it "should be able to update avatar" do
        ...
        assigns(:profile).avatar.to_s.should_not eq "//d2rbi2fqode2pf.cloudfront.net/users/avatars/avatar.jpg"
        response.code.should eq "200"
      end

...
Plan.create(:name => "Premium", :description => "for large sales companies", :price => 197, :max_agent_seats => 30, :features => ['unlimited agent seats', 'white labeled widget'], :plan_identifier => "ENTERPRISE")
